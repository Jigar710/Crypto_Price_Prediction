...
def find_pre(t):
    ...
    str2 = "E:/Test Minor Project/home/Data/Model/"+ str(t) + str("_LSTM.h5")
    str3 = "E:/Test Minor Project/home/Data/Model/"+ str(t) + str("_LSTM_Scaler.pickle")
    str4 = "E:/Test Minor Project/home/Data/Model/"+ str(t) + str("_LSTM_pred.pickle")
    df = pickle.load(open(str1,"rb"))
    model = load_model(str2)
    ...
    str12 = str(t) +  ' Future Price Prediction'
    plt.title(str12)
    plt.legend()
    global graph
    graph = get_graph()
